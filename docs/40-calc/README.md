...
| [CALC-GR-001](CALC-GR-001-ground-fault-current-with-zero-sequence.md) | 接地故障电流精确计算（含零序网络） | 单相接地 $I_f = E_a/(Z_1+Z_2+Z_0+3Z_f)$；零序阻抗归算；变压器接地方式影响 | GB/T 15544.1-2013, GB 51348-2019, GB/T 1094.11-2022 | TH-021（中性点接地）·CALC-PT-001（零序保护整定）·CALC-SC-001（低压短路） |
