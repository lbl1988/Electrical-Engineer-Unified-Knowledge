...
理论层 48 条已覆盖电磁/电路/电机/系统/电力电子/接地/保护/直流输电/柔性输电/微电网/分布式电源/次同步谐振/励磁系统/有载调压/频率稳定/断路器选型/交直流混联/DG 承载力/电力市场/AI 基础/电力电子化振荡/动态等值/电池热失控/电缆水树老化/黑启动优化全主干。剩余按需扩展方向：

- 可再生能源出力预测与不确定性建模（风/光出力概率预测、场景生成、鲁棒优化）
- 变压器套管爆裂故障物理（电容式套管/油中溶解气体/DGA 在线监测）
- 电力电子化设备宽频阻抗建模（构网型/跟网型 PCS 阻抗、有源阻尼、PLL 耦合）
- 柔性直流输电 MTDC 故障穿越与恢复（多端直流、直流断路器、限流电抗器）
