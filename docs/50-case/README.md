...
| ID | 子域 | 类型 | 年份 | 主题 | 核心关联 |
|---|---|---|---|---|---|
| [CASE-055](CASE-055-exam-2025-fa-high-voltage-dc-component.md) | EX | exam | 2025 | 发输变电：三相短路直流分量衰减与断路器校验 | CALC-SC-003/004, TH-015 |
| [CASE-056](CASE-056-exam-2018-pd-arc-overvoltage-and-hvdc-dc-bias.md) | EX | exam | 2018 | 供配电：弧光接地过电压 + HVDC 直流偏磁 | CALC-FT-001, CALC-GR-001, TH-053 |
| [CASE-057](CASE-057-review-cable-fireproof-seal-common-errors.md) | DR | review | 2025 | 校审：电缆防火封堵三项常见错误 | GB 50016, CECS 174 |
| [CASE-058](CASE-058-review-pv-grid-connection-protection-misoperation.md) | DR | review | 2024 | 校审：光伏并网保护三项误动隐患 | CALC-PT-001, TH-030 |
| [CASE-059](CASE-059-accident-hvdc-commutation-failure-cascade.md) | AC | accident | 2023 | 事故：HVDC 换相失败连锁导致受端失压 | TH-027/040/052 |
| [CASE-060](CASE-060-composite-optical-storage-diesel-microgrid.md) | CP | composite | 2025 | 综合：工业光储柴微电网完整方案 | TH-029/048/056, PR-ES-001/PS-004 |

## 累计统计（十二批共 60 条）

| 子域 | 累计 | 本批新增 |
|---|---|---|
| EX 真题 | 13 | +2（2025 发输变电 + 2018 供配电） |
| DR 校审 | 22 | +2 |
| AC 事故 | 13 | +1（HVDC 换相失败） |
| CP 综合 | 12 | +1（光储柴微电网） |
| **合计** | **60** | **+6** |

## 后续规划（可选）

案例库累计 60 条已形成稳定结构。剩余可按需扩展方向：2026 年真题首发、数据中心冷却协同、消防应急电源 UPS 选型审核、地铁牵引整流器绝缘配合、新型电力系统惯量不足案例。
