...
- 上游：[TH-008 谐波机理](../10-theory/TH-008-harmonic-generation.md)、[TH-010 无功功率](../10-theory/TH-010-reactive-power.md)、[TH-018 瞬时功率 p-q 理论](../10-theory/TH-018-instantaneous-power-pq-theory.md)（APF 控制算法的物理源头，赤木变换推导补偿电流参考值）
