...
- 上游：[TH-011 同步电机次暂态电抗](../10-theory/TH-011-synchronous-machine-subtransient-reactance.md)（发电机近端短路的理论基础）、[TH-015 Park 方程](../10-theory/TH-015-synchronous-machine-park-equations.md)（次暂态电势导出与暂态衰减时间常数）、[TH-016 功角稳定基础](../10-theory/TH-016-synchronous-machine-power-angle-stability.md)（近端短路 $E_q'$ 取值与暂态稳定校核）、[TH-019 输电线路参数与长线方程](../10-theory/TH-019-transmission-line-parameters-long-line.md)（远端短路线路阻抗与分布参数修正）
