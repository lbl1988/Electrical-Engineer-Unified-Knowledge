...
> 覆盖国内与国际标准、基础理论与工程实践的全域电气工程知识库。**版本：一期（骨架期）验收 v1.0，2026-09-08。**
...
| [10-theory/](10-theory/) | 基础理论（L1）：五段式条目，二期建设 | 占位 |
| [20-standards/](20-standards/) | 标准库（L2）：国内 4 份索引＋国际 1 份＋**中外对照表 20 张**＋changelog | ✅ 7 份＋5 changelog |
| [30-practice/](30-practice/) | 工程实践（L3 九段式条目），二期建设 | 占位 |
| [40-calc/](40-calc/) | 计算方法库：**示范条目 CALC-SC-001（低压三相短路全算例）** | ✅ 1 份 |
...
理论层（10-theory）首批 30 条 → 实践层（30-practice）高频域 20 条（供配电系统/短路/防雷接地/照明）→ 计算库扩展（负荷/保护整定/蓄电池/照度）→ 手册速查索引 → 真题映射。
